    ...
    try:
        ...
        if not encrypted_otp:
            return {
                ...
                'body': json.dumps({'message': 'Failed to encrypt OTP'}, ensure_ascii=False)
            }
        ...
        if not store_otp_in_dynamodb(user_id, encrypted_otp):
            return {
                ...
                'body': json.dumps({'message': 'Failed to store OTP'})
            }
        ...
        if delivery_method == 'sms':
            ...
            return {
                ...
                'body': json.dumps({'message': 'Invalid delivery method'})
            }
        ...
        if success:
            ...
            return {
                ...
                'body': json.dumps({'message': 'Failed to send OTP'})
            }
